...
namespace bakalarska_praca.Models
{
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Attack>().HasData(new Attack { Id = 23, Message = "Possible TCP SYN DoS", Category = "SYN", Proto = "TCP", Severity = 9, SeverityCategory = "critical", Timestamp = new DateTime(2021, 3, 14, 1, 17, 49).ToUniversalTime(), Src_ip = "192.168.70.11", Dest_ip = "192.168.40.183" });
            modelBuilder.Entity<Attack>().HasData(new Attack { Id = 24, Message = "Error Based SQL Injection Detected", Category = "SQL", Proto = "TCP", Severity = 8, SeverityCategory = "high", Timestamp = new DateTime(2021, 3, 14, 5, 17, 49).ToUniversalTime(), Src_ip = "192.168.40.11", Dest_ip = "192.168.40.183" });
            modelBuilder.Entity<Attack>().HasData(new Attack { Id = 25, Message = "Possible ICMP flood PING DoS", Category = "ICMP", Proto = "TCP", Severity = 7, SeverityCategory = "high", Timestamp = new DateTime(2021, 3, 14, 10, 17, 49).ToUniversalTime(), Src_ip = "192.168.40.11", Dest_ip = "192.168.40.183" });
            modelBuilder.Entity<Attack>().HasData(new Attack { Id = 26, Message = "Error Based SQL Injection Detected", Category = "SQL", Proto = "UDP", Severity = 1, SeverityCategory = "low", Timestamp = new DateTime(2021, 3, 14, 10, 45, 49).ToUniversalTime(), Src_ip = "192.168.60.11", Dest_ip = "192.168.40.183" });
            modelBuilder.Entity<Attack>().HasData(new Attack { Id = 27, Message = "Possible TCP SYN DoS", Category = "SYN", Proto = "TCP", Severity = 9, SeverityCategory = "critical", Timestamp = new DateTime(2021, 3, 14, 21, 17, 49).ToUniversalTime(), Src_ip = "192.168.70.11", Dest_ip = "192.168.40.183" });
        }
    }
}
